...
class Settings:
    ...
    MAX_ACTIVE_MOBS = 40
    MAX_MOBS_PER_CHUNK = 5
    MOB_SPAWN_INTERVAL_MIN = 8
    MOB_SPAWN_INTERVAL_MAX = 20
    MIN_SPAWN_DISTANCE_FROM_PLAYER = 250
    MAX_SPAWN_DISTANCE_FROM_PLAYER = 900
    MINIMAP_UPDATE_INTERVAL = 0.25
    LIGHTING_UPDATE_INTERVAL = 0.05
    WATER_MOVE_SPEED_MULTIPLIER = 0.55
    WATER_ENERGY_DRAIN_PER_SECOND = 4
    WATER_DAMAGE_INTERVAL = 5
    WATER_MIN_DAMAGE_PERCENT = 0.10
    WATER_MAX_DAMAGE_PERCENT = 1.00
    WATER_DAMAGE_ESCALATION_PERCENT = 0.10
